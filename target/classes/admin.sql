...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='行查记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='值机信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='清洁信息记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 2
  DEFAULT CHARSET = utf8 COMMENT ='航班信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `flightInformation`
  DISABLE KEYS */;
/*!40000 ALTER TABLE `flightInformation`
  ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='航班信息和旅客标记联系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `flightInformation_passengerTag`
  DISABLE KEYS */;
/*!40000 ALTER TABLE `flightInformation_passengerTag`
  ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='航班信息和特殊航班联系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `flightInformation_specialFlight`
  DISABLE KEYS */;
/*!40000 ALTER TABLE `flightInformation_specialFlight`
  ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='货运信息记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='综合服务信息记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `integratedService`
  DISABLE KEYS */;
/*!40000 ALTER TABLE `integratedService`
  ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 10
  DEFAULT CHARSET = utf8 COMMENT ='旅客标记标签表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `passengerTag`
  DISABLE KEYS */;
INSERT INTO `passengerTag`
VALUES (1, 'VVIP'),
       (2, 'VIP'),
       (3, '白金卡'),
       (4, '金卡'),
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8 COMMENT ='特殊航班标记标签表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `specialFlight`
  DISABLE KEYS */;
INSERT INTO `specialFlight`
VALUES (1, '特殊团队'),
       (2, '过站航班');
/*!40000 ALTER TABLE `specialFlight`
  ENABLE KEYS */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='创建站坪信息记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-01-30 10:51:49